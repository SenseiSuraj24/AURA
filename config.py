...
# Empirically: under H=32 optimization-horizon, honest clients converge to ch1 ~0.11.
# Calibrated using 1st percentile of honest distribution (target 1% FPR).
FLTRUST_CH1_THRESHOLD = 0.0023
